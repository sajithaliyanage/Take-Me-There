...
public class SendAlerts extends AsyncTask<String,Void,String> {
    Context context;

    public SendAlerts(Context context){
    ...
    protected String doInBackground(String... params) {
        ...
        try{
            ...
            String link="http://hydrosaver.azurewebsites.net/takemethere/php/setemmergeny.php";
    ...
    protected void onPostExecute(String result){
       Log.i("Alert Now","###################### TOAST0"+ result);
        Toast.makeText(context, "ALERTED TO NEAREST POLICE STATION", Toast.LENGTH_SHORT).show();
